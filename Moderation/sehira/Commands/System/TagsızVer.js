...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let rolsuzuye = message.guild.members.cache.filter(m => m.user.username.includes(ayarlar.tag) || m.user.discriminator.includes(ayarlar.etiketTag) && !m.roles.cache.has(roller.tagRolü) && !m.roles.cache.has(roller.şüpheliRolü) && !m.roles.cache.has(roller.yasaklıTagRolü) &&  !m.roles.cache.has(roller.jailRolü) && !roller.kayıtsızRolleri.some(x => m.roles.cache.has(x)))
    ...
    let rollütagsiz = message.guild.members.cache.filter(m => m.user.username.includes(ayarlar.tag) || uye.user.discriminator.includes(ayarlar.etiketTag) && m.roles.cache.has(roller.tagRolü) && !m.roles.cache.has(roller.şüpheliRolü) && !m.roles.cache.has(roller.yasaklıTagRolü) &&  !m.roles.cache.has(roller.jailRolü) && !roller.kayıtsızRolleri.some(x => m.roles.cache.has(x)))
