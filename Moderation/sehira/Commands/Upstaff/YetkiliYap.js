...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(!uye.user.username.includes(ayarlar.tag) && !uye.user.username.includes(ayarlar.etiketTag)) return message.channel.send(`${cevaplar.prefix} ${uye} isimli üyenin isminde \`${ayarlar.tag}\` sembolü bulunamadığından iptal edildi.`);
