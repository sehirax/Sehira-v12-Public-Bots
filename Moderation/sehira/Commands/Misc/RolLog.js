...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if (!uye) return message.channel.send(`${cevaplar.prefix} __Hata__: Rol geçmişini görüntülüyebilmem için lütfen bir üye etiketle __Örn:__ \`${sistem.prefix}${module.exports.Isim} @sehira/ID\`!`).then(x => x.delete({timeout: 5000}));
