...
module.exports = {
  ...
  onRequest: async function (client, message, args, guild) {
    ...
    if(!rol && args[0] != "liste") return message.channel.send(`${cevaplar.prefix} Bir üyeye rol verip almak için lütfen __argümanları__ doldurun Örn: \`.rol ver/al/liste @sehira/ID <EtiketRol/RolID>\``).then(x => x.delete({timeout: 5000}));
