...
module.exports = async (oldUser, newUser) => {
    ...
    if(newUser.username.includes(ayarlar.tag) && !user.roles.cache.has(roller.tagRolü) && newUser.username.includes(ayarlar.etiketTag) && !user.roles.cache.has(roller.etiketRol)){
     ...
     } else if(!newUser.username.includes(ayarlar.tag) && user.roles.cache.has(roller.tagRolü) && newUser.username.includes(ayarlar.etiketTag) && !user.roles.cache.has(roller.etiketRol)){
